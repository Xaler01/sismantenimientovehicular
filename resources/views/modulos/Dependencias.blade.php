                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-lg" name="cod_distrito" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-lg" name="cod_circuito" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-lg" name="cod_subcircuito" required>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="cod_distrito">Cod. Distrito:</label>
                                    <input type="number" class="form-control input-lg" name="cod_distrito" id="cod_distritoM" value="{{$dependencia->cod_distrito}}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nombre_distrito">Nombre Distrito:</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="cod_circuito">Cod. Circuito:</label>
                                    <input type="number" class="form-control input-lg" name="cod_circuito" id="cod_circuitoM" value="{{$dependencia->cod_circuito}}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nombre_circuito">Nombre Circuito:</label>
                                ...
                                <div class="form-group">
                                    <label for="cod_subcircuito">Cod. Subcircuito:</label>
                                    <input type="number" class="form-control input-lg" name="cod_subcircuito" id="cod_subcircuitoM" value="{{$dependencia->cod_subcircuito}}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nombre_subcircuito">Nombre Subcircuito:</label>
