...
<div class="content-wrapper">
    <section class="content-header">
        <h3>Gestor de Personal Encargado</h3>
    </section>
    <section class="content">
        <div class="box">
            <div class="box-header">
                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#CrearEncargado">Nuevo Encargado</button>
            </div>
            <div class="box-body">
                    ...
                    <tbody>   
                        @foreach($encargados as $encargado)
                            ...
                            <tr>
                                ...
                                <td>{{ $encargado -> rango -> nombre }}</td>
                                <td>{{ $encargado -> tipoSangre->nombre }}</td>
                                <td>{{ $encargado -> rol }}</td>                           
                                <td>
                                <a href="Editar-Encargado/{{ $encargado->id}}">
                                    <button class="btn btn-success" nombre = "{{ $encargado -> name }}"><i class="fa fa-pencil"></i></button>
                                </a>
                                    <button class="btn btn-danger EliminarPolicia" Pid = "{{ $encargado -> id }}" nombre = "{{ $encargado -> name }}"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>                             
                            @endif                          
                        @endforeach 
...
<div id="CrearEncargado" class="modal fade">
