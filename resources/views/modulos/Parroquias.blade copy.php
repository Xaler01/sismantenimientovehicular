                ...
                <table class="table table-bordered table-hover table-striped dt-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Editar-Dependencia/{{ $parroquia->id}}">
                                    <button class="btn btn-success" nombre = "{{ $parroquia -> nombre }}"><i class="fa fa-pencil"></i></button>
                                </a>
                                <button class="btn btn-danger EliminarDependencia" Pid="{{ $parroquia->id}}" nombre="{{ $parroquia->nombre}}"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<div id="CrearParroquia" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="GET" action="{{ url('Parroquias') }}">
                @csrf
